...
async def get_recent_items(
    ...
    print(f"DEBUG: /api/recents called with uid={uid}, auth_header={request.headers.get('Authorization', '')[:30]}...")
    ...
    try:
        ...
        items.sort(key=lambda x: x.get("createdAt") or x.get("updatedAt") or "", reverse=True)
