  ...
  const handleLogin = async () => {
    try {
      ...
      if (result?.account) {
        ...
        setError("Sign-in was successful, but no account information was returned.");
      }
    } catch (error) {
      ...
      if (
        ...
        errorMessage.includes("AADB2C90091") ||
      ...
      if (
        ...
        setError(
          "A sign-in window is already open. Please complete the current sign-in process before trying again."
        );
        return;
      }
